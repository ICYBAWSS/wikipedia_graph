...
## My computer did all the hard scraping and proccesing for you! Just use the github pages link https://icybawss.github.io/wikipedia_graph/ no need to do anything below unless you would like to remake it or edit stuff. Turn OFF high performance mode and turn ON show links during pan/zoom for the full experience.
